...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RawRecord.case_number_orig'
        db.add_column(u'uke_rawrecord', 'case_number_orig',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RawRecord.case_number_orig'
        db.delete_column(u'uke_rawrecord', 'case_number_orig')
