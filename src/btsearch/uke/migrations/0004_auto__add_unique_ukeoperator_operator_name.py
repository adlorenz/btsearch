...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UkeOperator', fields ['operator_name']
        db.create_unique('Uke__OperatorMappings', ['operator_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'UkeOperator', fields ['operator_name']
        db.delete_unique('Uke__OperatorMappings', ['operator_name'])
