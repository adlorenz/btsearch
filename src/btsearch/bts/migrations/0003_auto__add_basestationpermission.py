...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BaseStationPermission'
        db.create_table(u'bts_basestationpermission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base_station', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bts.BaseStation'])),
            ('permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uke.Permission'])),
            ('station_id', self.gf('django.db.models.fields.CharField')(max_length=16, db_index=True)),
        ))
        db.send_create_signal(u'bts', ['BaseStationPermission'])


    def backwards(self, orm):
        # Deleting model 'BaseStationPermission'
        db.delete_table(u'bts_basestationpermission')
    ...
    models = {
        ...
        u'bts.basestationpermission': {
            'Meta': {'object_name': 'BaseStationPermission'},
