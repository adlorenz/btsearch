...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cell.date_ping'
        db.alter_column(u'bts_cell', 'date_ping', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Cell.date_ping'
        db.alter_column(u'bts_cell', 'date_ping', self.gf('django.db.models.fields.DateTimeField')(default='0000-00-00 00:00:00'))
